...
export function ParametresPage() {
  ...
  return (
    <AppShell
      title="Paramètres"
      subtitle="Catalogues classés par point — Zogbo et Gbégamey. Combos et boissons sont partagés ; les ventes restent séparées."
      actions={
        <>
          <ExportExcelButton
      ...
      <table className="data-table">
        <thead>
          <tr>
            ...
            <th scope="col">Plat de base à déduire</th>
            <th scope="col" className="col-actions">
              <span className="sr-only">Actions</span>
            </th>
          </tr>
            ...
            <tr key={row.id}>
              ...
              <td>
                <select
                  ...
                  value={row.baseDishName ?? ""}
                  aria-label={`Plat de base pour ${row.name}`}
                  onChange={(e) =>
                    onChange(
                      rows.map((r) =>
                        r.id === row.id
                          ? {
                              ...r,
                              baseDishName: e.target.value || null,
                            }
                          : r,
                      ),
                    )
